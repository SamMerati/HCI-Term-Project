...
&nbsp;<div class="stats">
    ...
    <br />
                ...
                <br>
    <br />
                <asp:Button ID="backButton" runat="server" Text="⏮" Width="10%" BackColor="White" BorderColor="Black" BorderStyle="None" Font-Size="50pt" OnClick="backButton_Click"/>
                <asp:Button ID="playButton" runat="server" Text="▶️" Width="10%" BackColor="White" BorderColor="Black" BorderStyle="None" Font-Size="50pt" OnClick="playButton_Click"/>
                <asp:Button ID="forwardButton" runat="server" Text="⏭" Width="10%" BackColor="White" BorderStyle="None" Font-Size="50pt" BorderColor="Black" OnClick="forwardButton_Click"/>
</asp:Content>
